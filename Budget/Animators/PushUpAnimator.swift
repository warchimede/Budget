...
class PushUpAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let fromVCFinalFrame = CGRect(x: containerFrame.minX, y: containerFrame.minY - containerFrame.height,
                                      width: containerFrame.width, height: containerFrame.height)
        toVC.view.frame = CGRect(x: containerFrame.minX, y: containerFrame.maxY,
                                 width: containerFrame.width, height: containerFrame.height)
